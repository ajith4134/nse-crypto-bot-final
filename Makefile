...
.PHONY: index test phase1 oss dev multi multi-crypto phase3 dash all crypto ci trading crypto-trade trading-t3 options-t4 journal-t5 alerts-t7 strategy-t8 brain-t8
