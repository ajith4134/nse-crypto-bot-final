# Independent connectivity audit — 20260717-184107

_Engine: **ast+networkx (fallback)** · modules: 892 · edges: 3153 · report-only._
...
- trading.screener.sources → trading.broker_sense.ui_data → trading.brain → trading.brain.researcher → trading.brain.brain_os → trading.brain.learn_loop → trading.direction.truth_ledger → trading.broker_sense.broker_features → trading.brain.boss → trading.online.controls → trading.online.live_loop → trading.screener → trading.screener.screener → …
- trading.screener.sources → trading.broker_sense.ui_data → trading.brain → trading.brain.researcher → trading.brain.brain_os → trading.brain.learn_loop → trading.direction.truth_ledger → trading.broker_sense.broker_features → trading.brain.boss → trading.online.live_loop → trading.screener → trading.screener.screener → …
- trading.screener.sources → trading.broker_sense.ui_data → trading.brain → trading.brain.researcher → trading.brain.brain_os → trading.brain.learn_loop → trading.direction.truth_ledger → trading.broker_sense.broker_features → trading.broker_sense.screeners → …
- trading.screener.sources → trading.broker_sense.ui_data → trading.brain.surface → trading.brain → trading.brain.researcher → trading.brain.brain_os → trading.brain.learn_loop → trading.direction.truth_ledger → trading.broker_sense.broker_features → trading.brain.boss → trading.online.controls → trading.online.live_loop → trading.screener → trading.screener.screener → …
- trading.screener.sources → trading.broker_sense.ui_data → trading.brain.surface → trading.brain → trading.brain.researcher → trading.brain.brain_os → trading.brain.learn_loop → trading.direction.truth_ledger → trading.broker_sense.broker_features → trading.brain.boss → trading.online.live_loop → trading.screener → trading.screener.screener → …
- trading.screener.sources → trading.broker_sense.ui_data → trading.brain.surface → trading.brain → trading.brain.researcher → trading.brain.brain_os → trading.brain.learn_loop → trading.direction.truth_ledger → trading.broker_sense.broker_features → trading.broker_sense.screeners → …
- trading.screener.sources → trading.broker_sense.ui_data → trading.brain.surface → trading.brain.track_record → trading.brain → trading.brain.researcher → trading.brain.brain_os → trading.brain.learn_loop → trading.direction.truth_ledger → trading.broker_sense.broker_features → trading.brain.boss → trading.online.controls → trading.online.live_loop → trading.screener → trading.screener.screener → …
- trading.screener.sources → trading.broker_sense.ui_data → trading.brain.surface → trading.brain.track_record → trading.brain → trading.brain.researcher → trading.brain.brain_os → trading.brain.learn_loop → trading.direction.truth_ledger → trading.broker_sense.broker_features → trading.brain.boss → trading.online.live_loop → trading.screener → trading.screener.screener → …
- trading.screener.sources → trading.broker_sense.ui_data → trading.brain.surface → trading.brain.track_record → trading.brain → trading.brain.researcher → trading.brain.brain_os → trading.brain.learn_loop → trading.direction.truth_ledger → trading.broker_sense.broker_features → trading.broker_sense.screeners → …
- trading.screener.sources → trading.broker_sense.ui_data → trading.brain.surface → trading.brain.track_record → trading.brain.ultra → trading.brain → trading.brain.researcher → trading.brain.brain_os → trading.brain.learn_loop → trading.direction.truth_ledger → trading.broker_sense.broker_features → trading.brain.boss → trading.online.controls → trading.online.live_loop → trading.screener → trading.screener.screener → …
- trading.screener.sources → trading.broker_sense.ui_data → trading.brain.surface → trading.brain.track_record → trading.brain.ultra → trading.brain → trading.brain.researcher → trading.brain.brain_os → trading.brain.learn_loop → trading.direction.truth_ledger → trading.broker_sense.broker_features → trading.brain.boss → trading.online.live_loop → trading.screener → trading.screener.screener → …
- trading.screener.sources → trading.broker_sense.ui_data → trading.brain.surface → trading.brain.track_record → trading.brain.ultra → trading.brain → trading.brain.researcher → trading.brain.brain_os → trading.brain.learn_loop → trading.direction.truth_ledger → trading.broker_sense.broker_features → trading.broker_sense.screeners → …
- trading.screener.sources → trading.broker_sense.ui_data → trading.brain.surface → trading.brain.track_record → trading.brain.ultra → trading.brain.researcher → trading.brain.brain_os → trading.brain.learn_loop → trading.direction.truth_ledger → trading.broker_sense.broker_features → trading.brain.boss → trading.online.controls → trading.online.live_loop → trading.screener → trading.screener.screener → …
- trading.screener.sources → trading.broker_sense.ui_data → trading.brain.surface → trading.brain.track_record → trading.brain.ultra → trading.brain.researcher → trading.brain.brain_os → trading.brain.learn_loop → trading.direction.truth_ledger → trading.broker_sense.broker_features → trading.brain.boss → trading.online.live_loop → trading.screener → trading.screener.screener → …
- trading.screener.sources → trading.broker_sense.ui_data → trading.brain.surface → trading.brain.track_record → trading.brain.ultra → trading.brain.researcher → trading.brain.brain_os → trading.brain.learn_loop → trading.direction.truth_ledger → trading.broker_sense.broker_features → trading.broker_sense.screeners → …
- trading.screener.sources → trading.broker_sense.ui_data → trading.brain.surface → trading.goal → trading.journal → trading.journal.journal → trading.brain → trading.brain.researcher → trading.brain.brain_os → trading.brain.learn_loop → trading.direction.truth_ledger → trading.broker_sense.broker_features → trading.brain.boss → trading.online.controls → trading.online.live_loop → trading.screener → trading.screener.screener → …
- trading.screener.sources → trading.broker_sense.ui_data → trading.brain.surface → trading.goal → trading.journal → trading.journal.journal → trading.brain → trading.brain.researcher → trading.brain.brain_os → trading.brain.learn_loop → trading.direction.truth_ledger → trading.broker_sense.broker_features → trading.brain.boss → trading.online.live_loop → trading.screener → trading.screener.screener → …
- trading.screener.sources → trading.broker_sense.ui_data → trading.brain.surface → trading.goal → trading.journal → trading.journal.journal → trading.brain → trading.brain.researcher → trading.brain.brain_os → trading.brain.learn_loop → trading.direction.truth_ledger → trading.broker_sense.broker_features → trading.broker_sense.screeners → …
- trading.screener.sources → trading.broker_sense.ui_data → trading.brain.surface → trading.goal → trading.journal → trading.journal.journal → trading.brain.track_record → trading.brain → trading.brain.researcher → trading.brain.brain_os → trading.brain.learn_loop → trading.direction.truth_ledger → trading.broker_sense.broker_features → trading.brain.boss → trading.online.controls → trading.online.live_loop → trading.screener → trading.screener.screener → …
- trading.screener.sources → trading.broker_sense.ui_data → trading.brain.surface → trading.goal → trading.journal → trading.journal.journal → trading.brain.track_record → trading.brain → trading.brain.researcher → trading.brain.brain_os → trading.brain.learn_loop → trading.direction.truth_ledger → trading.broker_sense.broker_features → trading.brain.boss → trading.online.live_loop → trading.screener → trading.screener.screener → …
- trading.screener.sources → trading.broker_sense.ui_data → trading.brain.surface → trading.goal → trading.journal → trading.journal.journal → trading.brain.track_record → trading.brain → trading.brain.researcher → trading.brain.brain_os → trading.brain.learn_loop → trading.direction.truth_ledger → trading.broker_sense.broker_features → trading.broker_sense.screeners → …
- trading.screener.sources → trading.broker_sense.ui_data → trading.brain.surface → trading.goal → trading.journal → trading.journal.journal → trading.brain.track_record → trading.brain.ultra → trading.brain → trading.brain.researcher → trading.brain.brain_os → trading.brain.learn_loop → trading.direction.truth_ledger → trading.broker_sense.broker_features → trading.brain.boss → trading.online.controls → trading.online.live_loop → trading.screener → trading.screener.screener → …
- trading.screener.sources → trading.broker_sense.ui_data → trading.brain.surface → trading.goal → trading.journal → trading.journal.journal → trading.brain.track_record → trading.brain.ultra → trading.brain → trading.brain.researcher → trading.brain.brain_os → trading.brain.learn_loop → trading.direction.truth_ledger → trading.broker_sense.broker_features → trading.brain.boss → trading.online.live_loop → trading.screener → trading.screener.screener → …
- trading.screener.sources → trading.broker_sense.ui_data → trading.brain.surface → trading.goal → trading.journal → trading.journal.journal → trading.brain.track_record → trading.brain.ultra → trading.brain → trading.brain.researcher → trading.brain.brain_os → trading.brain.learn_loop → trading.direction.truth_ledger → trading.broker_sense.broker_features → trading.broker_sense.screeners → …
...
- `trading.state` ← 251 importers
- `trading` ← 202 importers
- `trading.broker_sense` ← 107 importers
- `core.node_protocol` ← 88 importers
- `trading.strategy.freqtrade_strategy_base` ← 81 importers
- `trading.brain` ← 77 importers
- `core` ← 54 importers
- `trading.direction` ← 51 importers
- `trading.broker_sense.binance_stream` ← 34 importers
- `trading.direction.truth_ledger` ← 34 importers
- `core.llm` ← 31 importers
...
- `trading.crypto.engine_client` ← 23 importers
...
- Undocumented on disk: **1** (first 1 shown)
  - `.cortex_build_job.py`
- Stale index entries (in INDEX.md, not on disk): **569**
