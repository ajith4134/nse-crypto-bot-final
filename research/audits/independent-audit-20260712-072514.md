# Independent connectivity audit — 20260712-072514

_Engine: **ast+networkx (fallback)** · modules: 776 · edges: 2551 · report-only._

## 1. Orphan modules (imported by nothing, not entrypoints/tests)
**124** found — candidates for dead subsystems or missing wiring:
...
- trading.crypto.freqtrade.percoin_decider → trading.crypto.freqtrade.brain_executor → trading.crypto.freqtrade.micro_policy → …
- trading.crypto.freqtrade.percoin_decider → trading.crypto.freqtrade.brain_executor → …
- trading.strategy.direction_equation → trading.broker_sense.indicator_fusion → trading.strategy.direction_equation_deploy → …
...
- trading.broker_sense.account_watchlist → trading.broker_sense.watchlist_study → trading.broker_sense.indicator_fusion → trading.evidence → trading.broker_sense.broker_features → trading.brain.boss → …
- trading.broker_sense.account_watchlist → trading.broker_sense.watchlist_study → trading.broker_sense.indicator_fusion → trading.strategy.direction_equation_deploy → trading.direction.mirror_gate → trading.direction.truth_ledger → trading.broker_sense.broker_features → trading.brain.boss → …
- trading.broker_sense.account_watchlist → trading.broker_sense.watchlist_study → trading.broker_sense.indicator_fusion → trading.strategy.direction_equation_deploy → trading.direction.truth_ledger → trading.broker_sense.broker_features → trading.brain.boss → …
- trading.broker_sense.account_watchlist → trading.broker_sense.watchlist_study → trading.direction.micro_features → trading.direction.truth_ledger → trading.broker_sense.broker_features → trading.brain.boss → …
- trading.broker_sense.account_watchlist → trading.broker_sense.watchlist_study → trading.direction.truth_ledger → trading.broker_sense.broker_features → trading.brain.boss → …
- trading.broker_sense.stock_xray → trading.broker_sense.indicator_fusion → trading.evidence → trading.broker_sense.broker_features → trading.brain.boss → trading.online.controls → trading.online.live_loop → …
- trading.broker_sense.stock_xray → trading.broker_sense.indicator_fusion → trading.evidence → trading.broker_sense.broker_features → trading.brain.boss → trading.online.live_loop → …
- trading.broker_sense.stock_xray → trading.broker_sense.indicator_fusion → trading.strategy.direction_equation_deploy → trading.direction.mirror_gate → trading.direction.truth_ledger → trading.broker_sense.broker_features → trading.brain.boss → trading.online.controls → trading.online.live_loop → …
- trading.broker_sense.stock_xray → trading.broker_sense.indicator_fusion → trading.strategy.direction_equation_deploy → trading.direction.mirror_gate → trading.direction.truth_ledger → trading.broker_sense.broker_features → trading.brain.boss → trading.online.live_loop → …
- trading.broker_sense.stock_xray → trading.broker_sense.indicator_fusion → trading.strategy.direction_equation_deploy → trading.direction.truth_ledger → trading.broker_sense.broker_features → trading.brain.boss → trading.online.controls → trading.online.live_loop → …
- trading.broker_sense.stock_xray → trading.broker_sense.indicator_fusion → trading.strategy.direction_equation_deploy → trading.direction.truth_ledger → trading.broker_sense.broker_features → trading.brain.boss → trading.online.live_loop → …
- trading.brain.boss → trading.online.controls → trading.online.live_loop → trading.crypto.freqtrade_ingest → trading.broker_sense.broker_features → …
- trading.brain.boss → trading.online.controls → trading.online.live_loop → trading.crypto.freqtrade_ingest → trading.strategy.champion_bandit → trading.broker_sense.broker_features → …
- trading.brain.boss → trading.online.controls → trading.online.live_loop → trading.direction.dir_exit → trading.direction.micro_features → trading.direction.truth_ledger → trading.broker_sense.broker_features → …
- trading.brain.boss → trading.online.controls → trading.online.live_loop → trading.direction.dir_exit → trading.direction.mirror_gate → trading.direction.truth_ledger → trading.broker_sense.broker_features → …
...
- `trading.journal.journal` → 12 deps
...
- Undocumented on disk: **1** (first 1 shown)
  - `.cortex_build_job.py`
- Stale index entries (in INDEX.md, not on disk): **497**
