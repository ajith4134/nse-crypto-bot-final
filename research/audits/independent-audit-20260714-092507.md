# Independent connectivity audit — 20260714-092507

_Engine: **ast+networkx (fallback)** · modules: 852 · edges: 2921 · report-only._
...
- trading.crypto.freqtrade.strategy_table → trading.crypto.freqtrade.percoin_decider → trading.crypto.freqtrade.brain_executor → …
...
- trading.online → trading.online.supervisor → trading.online.wallet → trading.journal → trading.journal.journal → trading.brain → trading.brain.researcher → trading.brain.brain_os → trading.brain.learn_loop → trading.direction.truth_ledger → trading.broker_sense.broker_features → trading.brain.boss → …
- trading.online → trading.online.supervisor → trading.online.wallet → trading.journal → trading.journal.journal → trading.brain → trading.brain.researcher → trading.brain.brain_os → trading.brain.learn_loop → trading.direction.truth_ledger → trading.broker_sense.broker_features → trading.brain.boss → trading.online.controls → trading.online.live_loop → …
- trading.online → trading.online.supervisor → trading.online.wallet → trading.journal → trading.journal.journal → trading.brain → trading.brain.researcher → trading.brain.brain_os → trading.brain.learn_loop → trading.direction.truth_ledger → trading.broker_sense.broker_features → trading.brain.boss → trading.online.live_loop → …
- trading.online → trading.online.supervisor → trading.online.wallet → trading.journal → trading.journal.journal → trading.brain.track_record → trading.brain → trading.brain.researcher → trading.brain.brain_os → trading.brain.learn_loop → trading.direction.truth_ledger → trading.broker_sense.broker_features → trading.brain.boss → …
- trading.online → trading.online.supervisor → trading.online.wallet → trading.journal → trading.journal.journal → trading.brain.track_record → trading.brain → trading.brain.researcher → trading.brain.brain_os → trading.brain.learn_loop → trading.direction.truth_ledger → trading.broker_sense.broker_features → trading.brain.boss → trading.online.controls → trading.online.live_loop → …
- trading.online → trading.online.supervisor → trading.online.wallet → trading.journal → trading.journal.journal → trading.brain.track_record → trading.brain → trading.brain.researcher → trading.brain.brain_os → trading.brain.learn_loop → trading.direction.truth_ledger → trading.broker_sense.broker_features → trading.brain.boss → trading.online.live_loop → …
- trading.online → trading.online.supervisor → trading.online.wallet → trading.journal → trading.journal.journal → trading.brain.track_record → trading.brain.ultra → trading.brain → trading.brain.researcher → trading.brain.brain_os → trading.brain.learn_loop → trading.direction.truth_ledger → trading.broker_sense.broker_features → trading.brain.boss → …
- trading.online → trading.online.supervisor → trading.online.wallet → trading.journal → trading.journal.journal → trading.brain.track_record → trading.brain.ultra → trading.brain → trading.brain.researcher → trading.brain.brain_os → trading.brain.learn_loop → trading.direction.truth_ledger → trading.broker_sense.broker_features → trading.brain.boss → trading.online.controls → trading.online.live_loop → …
- trading.online → trading.online.supervisor → trading.online.wallet → trading.journal → trading.journal.journal → trading.brain.track_record → trading.brain.ultra → trading.brain → trading.brain.researcher → trading.brain.brain_os → trading.brain.learn_loop → trading.direction.truth_ledger → trading.broker_sense.broker_features → trading.brain.boss → trading.online.live_loop → …
- trading.online → trading.online.supervisor → trading.online.wallet → trading.journal → trading.journal.journal → trading.brain.track_record → trading.brain.ultra → trading.brain.researcher → trading.brain.brain_os → trading.brain.learn_loop → trading.direction.truth_ledger → trading.broker_sense.broker_features → trading.brain.boss → …
- trading.online → trading.online.supervisor → trading.online.wallet → trading.journal → trading.journal.journal → trading.brain.track_record → trading.brain.ultra → trading.brain.researcher → trading.brain.brain_os → trading.brain.learn_loop → trading.direction.truth_ledger → trading.broker_sense.broker_features → trading.brain.boss → trading.online.controls → trading.online.live_loop → …
- trading.online → trading.online.supervisor → trading.online.wallet → trading.journal → trading.journal.journal → trading.brain.track_record → trading.brain.ultra → trading.brain.researcher → trading.brain.brain_os → trading.brain.learn_loop → trading.direction.truth_ledger → trading.broker_sense.broker_features → trading.brain.boss → trading.online.live_loop → …
- trading.online → trading.online.supervisor → trading.online.wallet → trading.journal → trading.journal.journal → trading.brain.trade_learn → trading.brain → trading.brain.researcher → trading.brain.brain_os → trading.brain.learn_loop → trading.direction.truth_ledger → trading.broker_sense.broker_features → trading.brain.boss → …
- trading.online → trading.online.supervisor → trading.online.wallet → trading.journal → trading.journal.journal → trading.brain.trade_learn → trading.brain → trading.brain.researcher → trading.brain.brain_os → trading.brain.learn_loop → trading.direction.truth_ledger → trading.broker_sense.broker_features → trading.brain.boss → trading.online.controls → trading.online.live_loop → …
- trading.online → trading.online.supervisor → trading.online.wallet → trading.journal → trading.journal.journal → trading.brain.trade_learn → trading.brain → trading.brain.researcher → trading.brain.brain_os → trading.brain.learn_loop → trading.direction.truth_ledger → trading.broker_sense.broker_features → trading.brain.boss → trading.online.live_loop → …
- trading.online → trading.online.supervisor → trading.online.wallet → trading.journal → trading.journal.journal → trading.brain.trade_learn → trading.brain.brain_os → trading.brain.learn_loop → trading.direction.truth_ledger → trading.broker_sense.broker_features → trading.brain.boss → …
- trading.online → trading.online.supervisor → trading.online.wallet → trading.journal → trading.journal.journal → trading.brain.trade_learn → trading.brain.brain_os → trading.brain.learn_loop → trading.direction.truth_ledger → trading.broker_sense.broker_features → trading.brain.boss → trading.online.controls → trading.online.live_loop → …
- trading.online → trading.online.supervisor → trading.online.wallet → trading.journal → trading.journal.journal → trading.brain.trade_learn → trading.brain.brain_os → trading.brain.learn_loop → trading.direction.truth_ledger → trading.broker_sense.broker_features → trading.brain.boss → trading.online.live_loop → …
- trading.online → trading.online.wallet → trading.journal → trading.journal.journal → trading.brain → trading.brain.researcher → trading.brain.brain_os → trading.brain.learn_loop → trading.direction.truth_ledger → trading.broker_sense.broker_features → trading.brain.boss → …
- trading.online → trading.online.wallet → trading.journal → trading.journal.journal → trading.brain → trading.brain.researcher → trading.brain.brain_os → trading.brain.learn_loop → trading.direction.truth_ledger → trading.broker_sense.broker_features → trading.brain.boss → trading.online.controls → trading.online.live_loop → …
- trading.online → trading.online.wallet → trading.journal → trading.journal.journal → trading.brain → trading.brain.researcher → trading.brain.brain_os → trading.brain.learn_loop → trading.direction.truth_ledger → trading.broker_sense.broker_features → trading.brain.boss → trading.online.live_loop → …
...
- `trading.state` ← 225 importers
- `trading` ← 180 importers
- `trading.broker_sense` ← 97 importers
- `core.node_protocol` ← 88 importers
- `trading.strategy.freqtrade_strategy_base` ← 81 importers
- `trading.brain` ← 69 importers
- `core` ← 54 importers
- `core.llm` ← 30 importers
- `trading.direction` ← 30 importers
- `eval.golden` ← 28 importers
- `trading.broker_sense.ui_data` ← 25 importers
- `core.registry` ← 23 importers
- `memory.neurons` ← 23 importers
- `trading.broker_sense.sessions` ← 22 importers
- `trading.direction.truth_ledger` ← 22 importers
- `trading.brain.mind_events` ← 21 importers
- `nodes.pool` ← 20 importers
- `trading.crypto.engine_client` ← 20 importers
- `trading.strategy.library.base` ← 20 importers
- `trading.broker_sense.binance_stream` ← 19 importers
- `trading.openalgo_client` ← 19 importers
...
- `trading.crypto.freqtrade.brain_executor` → 44 deps
- `trading.online.live_loop` → 40 deps
- `dashboard.server` → 38 deps
- `trading.broker_sense.funnel` → 30 deps
- `trading.broker_sense.run_funnel_loop` → 29 deps
...
- Undocumented on disk: **1** (first 1 shown)
  - `.cortex_build_job.py`
- Stale index entries (in INDEX.md, not on disk): **536**
