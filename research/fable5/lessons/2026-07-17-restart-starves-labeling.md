...
SUPERSEDED same day: candles now persist across restarts (commit 8a1f424) — the freeze
became unnecessary. The general form of the lesson: persist any RAM state that
