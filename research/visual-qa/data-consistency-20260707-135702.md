# Dashboard ↔ disk data-consistency — 2026-07-07 13:57
...
| closed trades | `/api/trading/closedtrades` | `trading/state/journal.json` | 2434 | 2374 | False | **mismatch** | api 2434 != disk 2374 — dashboard NOT true to disk |
