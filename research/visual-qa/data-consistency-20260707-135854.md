# Dashboard ↔ disk data-consistency — 2026-07-07 13:58
...
| closed trades | `/api/trading/closedtrades` | `trading/state/journal.json` | 2375 | 2374 | False | **mismatch** | api 2375 != disk 2374 — dashboard NOT true to disk |
