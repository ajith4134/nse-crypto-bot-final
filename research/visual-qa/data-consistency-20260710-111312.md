# Dashboard ↔ disk data-consistency — 2026-07-10 11:13
...
| closed trades | `/api/trading/closedtrades` | `trading/state/journal.json` | 3142 | 3130 | False | **mismatch** | api 3142 != disk 3130 — dashboard NOT true to disk |
