# Dashboard ↔ disk data-consistency — 2026-07-04 21:39
...
| closed trades | `/api/trading/closedtrades` | `journal.json` | 2071 | None | False | **mismatch** | no disk file; api shows 2071 rows with NO disk source (fabricated?) |
